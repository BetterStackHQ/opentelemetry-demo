...
generate-kubernetes-manifests:
	@echo "Generating Kubernetes manifests from upstream OpenTelemetry Helm chart..."
	...
	helm repo update
	@echo "Generating base Kubernetes manifest..."
	...
	@echo "Cleaning Kubernetes manifest to remove observability stack..."
	@if command -v ruby &> /dev/null && [ -f clean_k8s_manifest.rb ]; then \
		ruby clean_k8s_manifest.rb; \
		echo "Successfully generated cleaned Kubernetes manifest at kubernetes/opentelemetry-demo-cleaned.yaml"; \
		mv kubernetes/opentelemetry-demo-cleaned.yaml kubernetes/opentelemetry-demo.yaml; \
		echo "Successfully moved kubernetes/opentelemetry-demo-cleaned.yaml to kubernetes/opentelemetry-demo.yaml"; \
	else \
		echo "Warning: Ruby script not found or Ruby not installed. Only base manifest generated."; \
	fi
